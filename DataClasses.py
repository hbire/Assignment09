...
class Track():
    ...
    def __init__(self, position: str, title: str, length: str) -> None:
        """Set Position, Title, and Length of a new Track Object"""
        #    -- Attributes  -- #
        try:
            self.__track_position = int(position)
            self.__track_title = title
            self.__track_length = length
    ...
    def __str__(self):
        ...
        return '{:>2}\t{} (length: {})'.format(self.__track_position, self.__track_title, self.__track_length)

    def get_record(self) -> str:
        """Returns: Track record formatted for saving to file"""
        return '{},{},{}\n'.format(self.__track_position, self.__track_title, self.__track_length)
